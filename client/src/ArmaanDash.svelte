...
<div class="allDash-container">
    <div class="wheelArea-container">
        <div class="behindWheelScreen-container">
            ...
            <div class="dNav-container">
                ...
                <img src="overheatengine.png" alt="" height="40px">
                <img src="checkengine.png" alt="" height="40px">
                <img src="lockeddoors.png" alt="" height="40px">
                <img src="lowtire.png" alt="" height="40px">
                <img src="light.png" alt="" height="40px">
    ...
    <div class="entertainment-container">
        <div class="optionsInfo-container">
            ...
            <!--                <fontSize>-->
            <!--                    &lt;!&ndash; <p style="color:white">Temperature</p> &ndash;&gt;-->
            <!--                    <Temperature />-->
            <!--                </fontSize>-->
            <!--            </div>-->
        </div>
